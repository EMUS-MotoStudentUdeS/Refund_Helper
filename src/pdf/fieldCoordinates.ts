...
export const fieldCoordinates={
 groupName:{x:177,y:691,width:181,fontSize:10,minFontSize:7},
 ...
 reimburseTo:{x:177,y:633,width:181,fontSize:10,minFontSize:7},methodAccesd:{x:381,y:637,size:10},methodCheque:{x:381,y:622,size:10},
 contact:{x:177,y:589,width:181,fontSize:10,minFontSize:7},phone:{x:438,y:589,width:110,fontSize:10,minFontSize:7},email:{x:177,y:569,width:156,fontSize:10,minFontSize:7},
 amount:{x:214,y:530,width:61,fontSize:11,align:'right' as const},
 ...
 project:{x: 212.7, y: 333.4,width:181,fontSize:10,minFontSize:7},description:{x:214,y:250,width:333,height:58,lines:3,fontSize:10,minFontSize:7},
 president:{x:214,y:188,width:144,fontSize:9,minFontSize:7},treasurer:{x:395,y:188,width:152,fontSize:9,minFontSize:7},submittedDate:{x:214,y:151,width:99,fontSize:9,align:'center' as const}
