...
export const fieldCoordinates={
 ...
 contact:{x:177,y:591,width:181,fontSize:10,minFontSize:7},phone:{x:438,y:591,width:110,fontSize:10,minFontSize:7},email:{x:177,y:571,width:156,fontSize:10,minFontSize:7},
 ...
 project:{x:212.7,y:333.4,width:181,fontSize:10,minFontSize:7},description:{x:214,y:265,width:333,height:58,lines:3,fontSize:10,minFontSize:7},
 president:{x:214,y:225,width:144,fontSize:9,minFontSize:7},treasurer:{x:395,y:225,width:152,fontSize:9,minFontSize:7},
